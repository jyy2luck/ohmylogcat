...
**Reason**: Tag and Message editing moved to modal overlays with live apply; inline filter-row focus caused shortcut conflicts and complicated quit routing.

**Migration**: Use `t` / `m` or click Tag/Message summary to open the filter modal; Esc closes the modal. Filter values apply as you type.
